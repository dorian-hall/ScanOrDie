...
def Init(argv=None):
	...
	BuildUtil.PremakeParameters['Windows'] = { 'os': 'windows', 'generator': 'vs2019' }
...
def CreatePlatformBuilder(platformName, arches, configs, generateSwig, generatePremake, isMultiSDK):
